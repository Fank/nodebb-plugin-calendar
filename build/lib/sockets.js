...
pluginSockets.calendar.getEventsByDate = (sock, data, cb) => {
  (() => {
    var _ref10 = (0, _bluebird.coroutine)(function* (_ref11, _ref12) {
      ...
      const externalEvents = yield (0, _event.getExternalEventsByDate)(startDate, endDate);

      return [].concat((0, _toConsumableArray3.default)(withResponses), (0, _toConsumableArray3.default)(externalEvents));
    });
