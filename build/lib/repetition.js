...
exports.getOccurencesOfRepetition = undefined;
...
const getOccurencesOfRepetition = (event, start, end) => {
  ...
  const occurences = dates.map(date => (0, _extends3.default)({}, event, {
    startDate: date,
...
exports.getOccurencesOfRepetition = getOccurencesOfRepetition;
